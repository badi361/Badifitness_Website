<?php
    ...
    if ($_POST) {
        ...
        $sorgu = $baglan->query("delete from Referanslarımız");
        $sorgu = $baglan->query("insert into Referanslarımız (aciklama) values ('$aciklama')");
        echo "<script> window.location.href='referanslarimiz.php'; </script>";
    }
...
<head>
    <meta charset="utf-8">
    <title>Yönetim Paneli Referanslarımız</title>
</head>
