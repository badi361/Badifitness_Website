<?php
    ...
    if ($_POST)
    {
        ...
        {
            echo "<script>
                alert('HATALI KULLANICI BILGISI!'); window.location.href='admin.php';
            </script>";
        }
    }
?>
...
<body style="text-align:center;padding-top:50px;">
    <form action="" method="post">
        ...
        <input type="text" name="kullanici" size="30" required><br>
        <b>Parola:</b><br>
        <input type="password" name="sifre" size="30" required><br><br>
